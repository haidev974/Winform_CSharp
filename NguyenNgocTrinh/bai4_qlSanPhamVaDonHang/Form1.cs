...
using bai4_qlSanPhamVaDonHang.Models;
...
namespace bai4_qlSanPhamVaDonHang
{
    public partial class Form1 : Form
    {
        ...
        private void LoadDataByDate(DateTime fromDate, DateTime toDate)
        {
            ...
            // Kiểm tra xem iList có chứa các hóa đơn không
            if (!iList.Any())
            {
            ...
            // Lọc danh sách hóa đơn theo khoảng thời gian giao hàng (>= fromDate và < toDate)
